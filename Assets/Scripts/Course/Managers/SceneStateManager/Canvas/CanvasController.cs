using Course.Base;
using Course.Managers.SceneStateManager.Animation;
using Course.Managers.SceneStateManager.State;
using Course.Managers.SceneStateManager.State.Callbacks;
using UnityEngine;
using Zenject;

namespace Course.Managers.SceneStateManager.Canvas
{
  public sealed class CanvasController : AbstractBehaviour, IOnStateActivate, IOnStateDeactivate, IOnStateBecomeTopmost,
                                         IOnStateResignTopmost, IOnStateSortingOrderChanged
  {
